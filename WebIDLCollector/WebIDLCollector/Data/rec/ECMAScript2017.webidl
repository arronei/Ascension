...
interface Atomics {
    ...
    static unsigned long or((Int8Array or Uint8Array or Int16Array or Uint16Array or Int32Array or Uint32Array) typedArray, unsigned long index, unsigned long value);
    ...
    static DOMString wait(Int32Array typedArray, unsigned long index, unsigned long value, optinal float timeout);
...
interface Object {
    ...
    static sequence<object> entries(object obj);
    static object freeze(object obj);
    static PropertyDescriptor getOwnPropertyDescriptor(object obj, DOMString propertyKey);
    static sequence<PropertyDescriptor> getOwnPropertyDescriptors(object obj, DOMString propertyKey);
    ...
    static object seal(object obj);
    static object setPrototypeOf(object obj, object prototype);
    static sequence<object> values(object obj);
...
typedef record<DOMString, PropertyDescriptor> PropertyDescriptors;
...
interface Promise {
    static Promise all(object iterable);
...
interface String {
    ...
    boolean endsWith(DOMString searchString, optional unsigned long long endPosition);
    boolean includes(DOMString searchString, optional unsigned long long position);
    long long indexOf(DOMString searchString, optional unsigned long long position);
    long long lastIndexOf(DOMString searchString, optional unsigned long long position);
    long localeCompare(object that, optional DOMString locales, optional object options);
    ...
    Array split(DOMString separator, unsigned long long limit);
