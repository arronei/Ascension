...
namespace System.IO.Csv
{
    ...
    public partial class CsvReader : IDataReader, IEnumerable<string[]>, IDisposable
    {
        ...
        #region Constructors
        /// <summary>Initializes a new instance of the CsvReader class.</summary>
        ...
        public CsvReader(TextReader reader, bool hasHeaders) : this(reader, hasHeaders, DefaultDelimiter, DefaultQuote, DefaultEscape, DefaultComment, ValueTrimmingOptions.UnquotedOnly, DefaultBufferSize)
        {
        }
        ...
        /// <exception cref="T:ArgumentNullException"><paramref name="reader"/> is a <see langword="null"/>.</exception>
        /// <exception cref="T:ArgumentException">Cannot read from <paramref name="reader"/>.</exception>
        public CsvReader(TextReader reader, bool hasHeaders, int bufferSize) : this(reader, hasHeaders, DefaultDelimiter, DefaultQuote, DefaultEscape, DefaultComment, ValueTrimmingOptions.UnquotedOnly, bufferSize)
        {
        }
        ...
        /// <exception cref="T:ArgumentNullException"><paramref name="reader"/> is a <see langword="null"/>.</exception>
        /// <exception cref="T:ArgumentException">Cannot read from <paramref name="reader"/>.</exception>
        public CsvReader(TextReader reader, bool hasHeaders, char delimiter) : this(reader, hasHeaders, delimiter, DefaultQuote, DefaultEscape, DefaultComment, ValueTrimmingOptions.UnquotedOnly, DefaultBufferSize)
        {
        }
        ...
        /// <exception cref="T:ArgumentNullException"><paramref name="reader"/> is a <see langword="null"/>.</exception>
        /// <exception cref="T:ArgumentException">Cannot read from <paramref name="reader"/>.</exception>
        public CsvReader(TextReader reader, bool hasHeaders, char delimiter, int bufferSize) : this(reader, hasHeaders, delimiter, DefaultQuote, DefaultEscape, DefaultComment, ValueTrimmingOptions.UnquotedOnly, bufferSize)
        {
        }
        ...
        /// <exception cref="T:ArgumentNullException"><paramref name="reader"/> is a <see langword="null"/>.</exception>
        /// <exception cref="T:ArgumentException">Cannot read from <paramref name="reader"/>.</exception>
        public CsvReader(TextReader reader, bool hasHeaders, char delimiter, char quote, char escape, char comment, ValueTrimmingOptions trimmingOptions) : this(reader, hasHeaders, delimiter, quote, escape, comment, trimmingOptions, DefaultBufferSize)
        {
        }
        ...
        {
#if DEBUG
            _allocStack = new Diagnostics.StackTrace();
#endif
        ...
        /// <summary>Raises the <see cref="M:ParseError"/> event.</summary>
        ...
        #region Indexers
        /// <summary>Gets the field with the specified name and record position. <see cref="M:hasHeaders"/> must be <see langword="true"/>.</summary>
        ...
        /// <summary>Gets the field at the specified index and record position.</summary>
        /// <value>
        ...
        /// <summary>Gets the field with the specified name. <see cref="M:hasHeaders"/> must be <see langword="true"/>.</summary>
        ...
        /// <summary>Gets the field at the specified index.</summary>
        ...
        /// <summary>Gets the field index for the provided header.</summary>
        ...
        #region MoveTo
        /// <summary>Moves to the specified record index.</summary>
        ...
        #region ParseNewLine
        /// <summary>Parses a new line delimiter.</summary>
        ...
        /// <summary>Determines whether the character at the specified position is a new line delimiter.</summary>
        ...
        #region ReadField
        /// <summary>Reads the field at the specified index. Any unread fields with an inferior index will also be read as part of the required parsing.</summary>
        ...
        /// <returns>The field at the specified index. A <see langword="null"/> indicates that an error occured or that the last field has been reached during initialization.</returns>
        ...
        /// <summary>Reads the next record.</summary>
        /// <param name="onlyReadHeaders">Indicates if the reader will proceed to the next record after having read headers. <see langword="true"/> if it stops after having read headers; otherwise, <see langword="false"/>.</param>
        /// <param name="skipToNextLine">Indicates if the reader will skip directly to the next line without parsing the current one. To be used when an error occurs.</param>
        /// <returns><see langword="true"/> if a record has been successfully reads; otherwise, <see langword="false"/>.</returns>
        /// <exception cref="T:System.ComponentModel.ObjectDisposedException">The instance has been disposed of.</exception>
        ...
        /// <summary>Skips empty and commented lines. If the end of the buffer is reached, its content be discarded and filled again from the reader.</summary>
        /// <param name="pos">The position in the buffer where to start parsing. Will contains the resulting position after the operation.</param>
        ...
        /// <summary><para>Worker method.</para> <para>Skips empty and commented lines.</para></summary>
        /// <param name="pos">The position in the buffer where to start parsing. Will contains the resulting position after the operation.</param>
        /// <exception cref="T:System.ComponentModel.ObjectDisposedException">The instance has been disposed of.</exception>
        ...
        /// <summary> Skips ahead to the next NewLine character. If the end of the buffer is reached, its content be discarded and filled again from the reader.</summary>
        /// <param name="pos">The position in the buffer where to start parsing. Will contains the resulting position after the operation.</param>
        /// <returns><see langword="true"/> if the end of the reader has not been reached; otherwise, <see langword="false"/>.</returns>
        /// <exception cref="T:System.ComponentModel.ObjectDisposedException">The instance has been disposed of.</exception>
        ...
        /// <summary>Handles a parsing error.</summary>
        ...
        /// <summary>Handles a missing field error.</summary>
        ...
        /// <summary>Validates the state of the data reader.</summary>
        ...
        /// <summary>Copy the value of the specified field to an array.</summary>
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!_isDisposed)
            {
                try
                {
                    ...
                    // Dispose-time code should also set references of all owned objects to null, after disposing them.
                    // This will allow the referenced objects to be garbage collected even if not all references to the "parent" are released.
                    // It may be a significant memory consumption win if the referenced objects are large, such as big arrays, collections, etc.
                    if (disposing)
                    {
        ...
        /// <summary>Releases unmanaged resources and performs other cleanup operations before the instance is reclaimed by garbage collection.</summary>
        ~CsvReader()
        {
#if DEBUG
